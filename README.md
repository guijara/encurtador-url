# Encurtador de URL - Estudos Backend
...
## 🛠️ Tecnologias Atuais (Stack Inicial)
* **Java 21**
...
## 🚀 Como rodar
* Clone o repositório.
* Execute o projeto via IntelliJ ou `./mvnw spring-boot:run`.
* Acesse `GET /ping` para verificar se o servidor está online.

---
*Desenvolvido como parte dos estudos de Ciência da Computação (UFMT).*