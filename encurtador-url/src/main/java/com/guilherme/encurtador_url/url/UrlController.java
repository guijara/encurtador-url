...
public class UrlController {
    ...
    @ApiStandardErrors
    @ApiResponse(responseCode = "302",description = "O processo deu certo e o link foi redirecionado corretamente",content = @Content(schema = @Schema(implementation = ApiError.class)))
    @ApiResponse(responseCode = "404", description = "O processo deu erro por URL não encontrada no banco de dados.",content = @Content(schema = @Schema(implementation = ApiError.class)))
    @GetMapping("/{shortUrl}")
    ...
    @ApiStandardErrors
    @ApiResponse(responseCode = "201",description = "O processo deu certo e a URL encurtada foi criada com sucesso.",content = @Content(schema = @Schema(implementation = ApiError.class)))
    @ApiResponse(responseCode = "400",description = "O processo deu erro por input inválido da URL original.",content = @Content(schema = @Schema(implementation = ApiError.class)))
    @ApiResponse(responseCode = "410",description = "O processo deu erro porquê a URL está expirada",content = @Content(schema = @Schema(implementation = ApiError.class)))
    ...
    @ApiStandardErrors
    @ApiResponse(responseCode = "204",description = "Url foi deletada com sucesso",content = @Content(schema = @Schema(implementation = ApiError.class)))
    @ApiResponse(responseCode = "404", description = "URL não encontrada",content = @Content(schema = @Schema(implementation = ApiError.class)))
    ...
    @ApiStandardErrors
    @ApiResponse(responseCode = "200", description = "Retorna a página da lista de URLs do usuário", content = @Content(schema = @Schema(implementation = ApiError.class)))
    @GetMapping("/api/urls")
